...
2. `cd terraform`, edit some variable on [var_over.sh]() {execute this script after} (or variables.tf default value) then `terraform init; terraform plan; terraform apply;` wait for sometimes ~30m to 1hr for env creation.
